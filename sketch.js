...
function draw() 
{
  ...
  rope.show();
  rope2.show();
  console.log(higherground.body.position.x); 
  if(fruit!=null){ var collision = Matter.SAT.collides(fruit,higherground.body); console.log(collision); if(collision.collided){ bunny.changeAnimation("crying"); fruit = null; bubble.visible = false;}}
...
if(fruit!=null){
  if(fruit.position.y>1000||fruit.position.y<0){
